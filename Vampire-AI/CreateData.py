...
file_name = "C:/Users/pondy/Desktop/game/data/training_data.npy"
file_name2 = "C:/Users/pondy/Desktop/game/data/target_data.npy"
...
while True:
    ...
    print('loop took {:.3f} seconds'.format(time.time()-last_time),keys)
